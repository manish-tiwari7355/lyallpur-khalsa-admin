...
const policy = () => {
  return (
    <div className="p-20 container mx-auto">
      <h1>Privacy Policy for OHM Wholesale Trucking Show under Punjabi Trucking USA </h1>

      <p>
        At OHM Wholesale Trucking Show, accessible from https://punjabitruckingusa.com/, one of our
        main priorities is the privacy of our visitors. This Privacy Policy document contains types
        of information that is collected and recorded by OHM Wholesale Trucking Show and how we use
        it.
      </p>
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in OHM Wholesale
        Trucking Show. This policy is not applicable to any information collected offline or via
      ...
      <p>
        OHM Wholesale Trucking Show follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, OHM Wholesale Trucking Show uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        OHM Wholesale Trucking Show.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
        Beacons that are used in their respective advertisements and links that appear on OHM
        Wholesale Trucking Show, which are sent directly to users' browser. They automatically
      ...
      <p>
        Note that OHM Wholesale Trucking Show has no access to or control over these cookies that
      ...
      <p>
        OHM Wholesale Trucking Show's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        OHM Wholesale Trucking Show does not knowingly collect any Personal Identifiable Information
