...
const ContactTable = (props) => {
  ...
  const noticeBoardColumns = [
...

    {
      ...
      align: 'left',
      datIndex: '',
      render: (records) => <div className="capitalize">{records?.name}</div>,
    },
    {
      title: 'Phone',
      key: 'phone',
    ...
    },
    {
      ...
      align: 'left',
      datIndex: '',
      render: (records) => <div className="capitalize">{records?.subject}</div>,
    },
    {
      title: 'Message',
      key: 'message',
...
export default connect(null)(ContactTable);
