...
function Media({ dispatch, loading }) {
  ...
  const [contents, setContents] = useState([]);
  console.log(contents, 'llll');
  useEffect(() => {
    // eslint-disable-next-line no-underscore-dangle
    if (recordId) {
      dispatch({
        type: 'media/getSingleMediaList',
        payload: {
  ...
  return (
    <div className="container mx-auto">
      <Page title={recordId ? 'Edit Media' : 'Add Media'}>
        <div>
                  ...
                  <Col xl={12} lg={12} md={12} sm={24} xs={24}>
                    <div className="p-5 bg-white rounded-md">
                      ...
                      <Col xl={24} lg={24} md={24} sm={24} xs={24}>
                        <div className=" text-left ">Upload Images (Upload 2 images only)</div>
...
const mapStateToProps = ({ user, loading }) => ({
  ...
  loading: loading.effects['media/AddMediaBoard'],
});
