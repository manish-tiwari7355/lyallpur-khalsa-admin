...
const UpdatedInVoice = ({ visible, setVisible, orderId, dispatch, orderData }) => {
  ...
  return (
    <div>
      <Modal
        ...
        //   </div>
        // }
        bodyStyle={{ width: '1200px', justifyContent: 'center', backgroundColor: 'white' }}
      >
              ...
              <div className="flex flex-row w-full ">
                ...
                <div className="mt-6 ">
                  <img
                    src={logo1}
                    alt="OHM Wholesale"
                    style={{ height: 140, width: 250, marginRight: '20px' }}
                  />
                </div>
              </div>
            </div>
                ...
                return (
                  <div key={item?._id} style={{}} className="text-center  flex ">
                    ...
                    >
                      ...
                      orderData?.address?.state_code === 'Connecticut (CT)'
                        ? (
                            (!!item?.variants?.volume === false
                              ? 0
                              : item?.variants?.volume * 0.4) * item.quantity
                          ).toFixed(2)
                        : 0}
                    </div>
                    <div
